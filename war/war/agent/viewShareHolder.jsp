...
<html>
	...
	<body>
								...
								<table width="100%" cellpadding="0" cellspacing="0" border="0"
									...
									<tr>
										...
										<td style="text-align: left">
											<c:out value="${shareHolder.agent.name}" />
										</td>
									</tr>
									<tr>
										<td class="lef">
										...
										<td style="text-align: left">
											<c:out value="${shareHolder.company.name}" />
										</td>
									</tr>
									<tr>
										<td class="lef">
									...
									<tr>
										<td align="center">
											...
											<input name="label" type="button" class="button1" value="编 辑"
												onclick="edit(<c:out value='${shareHolder.id}' />);">
		...
		function edit(id){
   			 var url="../agent/shareHolderList.do?thisAction=edit&id="+id;
