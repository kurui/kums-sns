					...
					<table width="100%" cellpadding="0" cellspacing="0" border="0">
						...
						<tr>
							...
							<td valign="top" class="body">
								<c:import url="../page/mainTitle.jsp?title1=新闻发布&title2=新闻列表" charEncoding="UTF-8" />
								<div class="searchBar">
								...
								<table width="100%" cellpadding="0" cellspacing="0" border="0" class="dataList">
									...
									<c:forEach var="info" items="${nlf.list}" varStatus="status">
										<tr>
											...
											<td>
												<html:multibox property="selectedItems" value="${info.id}" onclick="checkItem(this, 'sele')">
												</html:multibox>
											</td>
											<td>
												<html:link page="/information/newsList.do?thisAction=view&id=${info.id}">
